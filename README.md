...
├── Ground Truth/                       
│   └── annotation.csv                  # Manually annotated shot boundaries (frame indices)
│                                       # Used for evaluating all detection algorithms

├── output_adaptive_detector/           # Results generated by AdaptiveDetector
...
├── 03_grid_search_parameters_adaptive_detector.sbatch  # SLURM adaptive grid search
├── 03_grid_search_parameters_histogtam_detector.sbatch # SLURM histogram grid search
...
### Step 2 — (Optional) Frame Extraction
...
### Step 3 — Deep Learning Detection (TransNetV2)
...
**Mohammad Azizul Islam Yasin — Shot Boundary Detection in Soccer**
...
📧 [azizulislamyasin@gmail.com](mailto:azizulislamyasin@gmail.com)
